...
//		#undef _DFX_FOG_
	...
	void dfx_mtl_shaded_startup () {
		...
		//id:137
		//cntl: slider 0 255 1
		mtl_shaded->specular_red = 255.0;
		
		//entry: specular_green
		//id:138
		//cntl: slider 0 255 1
		mtl_shaded->specular_green = 255.0;
		
		//entry: specular_blue
		//id:139
		//cntl: slider 0 255 1
		mtl_shaded->specular_blue = 255.0;
		
		//entry: power
		//id:140
		//cntl: slider 1 16 1
		mtl_shaded->power = 8.0;
...
//		#undef _DFX_FOG_
	...
	function dfx_mtl_model_startup () {
		...
		//id:237
		//cntl: slider 0 255 1
		mtl_model->specular_red = 255.0;
		
		//entry: specular_green
		//id:238
		//cntl: slider 0 255 1
		mtl_model->specular_green = 255.0;
		
		//entry: specular_blue
		//id:239
		//cntl: slider 0 255 1
		mtl_model->specular_blue = 255.0;
